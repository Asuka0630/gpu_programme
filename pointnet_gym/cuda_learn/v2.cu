...
__always_inline void Conv1dTile128_call(float *input, float *output, float *weight, float *bias, int batch_size, int N, int in_channel, int out_channel)
{
    int m = batch_size * N;
    int n = out_channel;
    int k = in_channel;
    ...
    Tiled128GemmAddVec<<<gridDim, blockDim>>>(input, weight, output, bias, m, n, k);
}
/**
...
__always_inline void conv1dTile128_bn_relu_block_call(float *input, float *lin_weight, float *lin_bias, float *running_mean, float *running_var, float *bn_weight, float *bn_bias, float *output, int batch_size, int n, int ci, int co)
{
    Conv1dTile128_call(input, output, lin_weight, lin_bias, batch_size, n, ci, co);
    dim3 blockDim(blockSize, blockSize);
    dim3 gridDim(CEIL(co, blockDim.x), CEIL(batch_size * n, blockDim.y));
    BatchNorm1dWithReLU<float, blockSize><<<gridDim, blockDim>>>(output, output, bn_weight, bn_bias, running_mean, running_var, batch_size, n, co);
}
...
__always_inline void mlp_bn_relu_block_f32call(float *input, float *lin_weight, float *lin_bias, float *running_mean, float *running_var, float *bn_weight, float *bn_bias, float *output, int batch_size, int n, int ci, int co)
{
...
void batch_infer(std::unordered_map<std::string, T *> &params, T *batch_data, T *blk_out[], T *tmp, T *batch_out, int truncated_length, int batch_size)
{
    ...
    conv1dTile128_bn_relu_block_call<32>(blk1_out, params["feat.fstn.conv2.weight"], params["feat.fstn.conv2.bias"], params["feat.fstn.bn2.running_mean"], params["feat.fstn.bn2.running_var"], params["feat.fstn.bn2.weight"], params["feat.fstn.bn2.bias"], blk2_out, batch_size, truncated_length, 64, 128);   // feat.fstn.conv2.weight=[64, 128], feat.fstn.conv2.bias=[128], feat.fstn.bn2.running_mean=[128], feat.fstn.bn2.running_var=[128], feat.fstn.bn2.weight=[128], feat.fstn.bn2.bias=[128]
    conv1dTile128_bn_relu_block_call<32>(blk2_out, params["feat.fstn.conv3.weight"], params["feat.fstn.conv3.bias"], params["feat.fstn.bn3.running_mean"], params["feat.fstn.bn3.running_var"], params["feat.fstn.bn3.weight"], params["feat.fstn.bn3.bias"], blk3_out, batch_size, truncated_length, 128, 1024); // feat.fstn.conv3.weight=[1024, 128], feat.fstn.conv3.bias=[1024], feat.fstn.bn3.running_mean=[1024], feat.fstn.bn3.running_var=[1024], feat.fstn.bn3.weight=[1024], feat.fstn.bn3.bias=[1024]

    maxReduce_call<float, 128>(blk3_out, tmp, blk4_out, batch_size, truncated_length, 1024);

    mlp_bn_relu_block_f32call<32>(blk4_out, params["feat.fstn.fc1.weight"], params["feat.fstn.fc1.bias"], params["feat.fstn.bn4.running_mean"], params["feat.fstn.bn4.running_var"], params["feat.fstn.bn4.weight"], params["feat.fstn.bn4.bias"], blk5_out, batch_size, 1, 1024, 512); // feat.fstn.fc1.weight=[512, 1024], feat.fstn.fc1.bias=[512], feat.fstn.bn4.running_mean=[512], feat.fstn.bn4.running_var=[512], feat.fstn.bn4.weight=[512], feat.fstn.bn4.bias=[512]
    ...
    conv1dTile128_bn_relu_block_call<32>(blk11_out, params["feat.conv2.weight"], params["feat.conv2.bias"], params["feat.bn2.running_mean"], params["feat.bn2.running_var"], params["feat.bn2.weight"], params["feat.bn2.bias"], blk2_out, batch_size, truncated_length, 64, 128);  // feat.conv2.weight=[128, 64], feat.conv2.bias=[128], feat.bn2.running_mean=[128], feat.bn2.running_var=[128], feat.bn2.weight=[128], feat.bn2.bias=[128]
    conv1dTile128_bn_relu_block_call<32>(blk2_out, params["feat.conv3.weight"], params["feat.conv3.bias"], params["feat.bn3.running_mean"], params["feat.bn3.running_var"], params["feat.bn3.weight"], params["feat.bn3.bias"], blk3_out, batch_size, truncated_length, 128, 1024); // feat.conv3.weight=[1024, 128], feat.conv3.bias=[1024], feat.bn3.running_mean=[1024], feat.bn3.running_var=[1024], feat.bn3.weight=[1024], feat.bn3.bias=[1024]

    maxReduce_call<float, 128>(blk3_out, tmp, blk4_out, batch_size, truncated_length, 1024);

    // model
    mlp_bn_relu_block_f32call<32>(blk4_out, params["fc1.weight"], params["fc1.bias"], params["bn1.running_mean"], params["bn1.running_var"], params["bn1.weight"], params["bn1.bias"], blk5_out, batch_size, 1, 1024, 512); // fc1.weight=[512, 1024], fc1.bias=[512], bn1.running_mean=[512], bn1.running_var=[512], bn1.weight=[512], bn1.bias=[512]

    mlp_bn_relu_block_f32call<32>(blk5_out, params["fc2.weight"], params["fc2.bias"], params["bn2.running_mean"], params["bn2.running_var"], params["bn2.weight"], params["bn2.bias"], blk6_out, batch_size, 1, 512, 256); // fc2.weight=[256, 512], fc2.bias=[256], bn2.running_mean=[256], bn2.running_var=[256], bn2.weight=[256], bn2.bias=[256]
